...
package com.grotesque.saa.common.widget.subscaleview;
...
import com.grotesque.saa.common.widget.subscaleview.decoder.CompatDecoderFactory;
import com.grotesque.saa.common.widget.subscaleview.decoder.DecoderFactory;
import com.grotesque.saa.common.widget.subscaleview.decoder.ImageDecoder;
import com.grotesque.saa.common.widget.subscaleview.decoder.ImageRegionDecoder;
import com.grotesque.saa.common.widget.subscaleview.decoder.SkiaImageDecoder;
import com.grotesque.saa.common.widget.subscaleview.decoder.SkiaImageRegionDecoder;
import com.grotesque.saa.util.FileCache;
import com.grotesque.saa.util.FileUtils;
...
public class SubSamplingScaleImageView extends View {
    ...
    private void init(Context context, AttributeSet attr) {
        if (mDraweeHolder == null) {
            ...
            GenericDraweeHierarchy hierarchy = builder.setProgressBarImage(new CustomProgressbarDrawable())
                    .build();
