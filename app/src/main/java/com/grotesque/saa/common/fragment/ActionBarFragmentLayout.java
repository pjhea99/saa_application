...
public class ActionBarFragmentLayout
  extends FrameLayout
{
  private final String a = ActionBarFragmentLayout.class.getSimpleName();
  private BaseActionBar mActionBar;
  
  public ActionBarFragmentLayout(Context paramContext)
  {
    super(paramContext);
  }
  
  public ActionBarFragmentLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }
  
  public ActionBarFragmentLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  {
    if (this.mActionBar != null) {
      this.mActionBar.selectTitleTab(paramTitleTap);
    }
  }
}
