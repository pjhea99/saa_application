...
public class OkHttpNetworkFetcher extends
  ...
  private static OkHttpNetworkFetcher mOkHttpNetworkFetcher;
  public static OkHttpNetworkFetcher getInstance(){
    if(mOkHttpNetworkFetcher == null)
      mOkHttpNetworkFetcher = new OkHttpNetworkFetcher();
    return mOkHttpNetworkFetcher;
  }
  ...
  public OkHttpNetworkFetcher() {
    mOkHttpClient = new OkHttpClient.Builder()
            .addInterceptor(FrescoInterceptor.createInterceptor())
            .build();
